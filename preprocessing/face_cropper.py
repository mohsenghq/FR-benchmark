...
class FaceCropper:
    ...
    def __init__(self,
                 ...
                 skip_existing: bool = True): # Added skip_existing option
        """
        Args:
        ...
        logger.info(f"FaceCropper initialized. Raw data: '{raw_dataset_root}', Cropped data output: '{cropped_dataset_root}', Detector: '{detector_backend}', Skip existing: {self.skip_existing}")

    def process_and_save_cropped_faces(self, identities_map: Dict[str, List[str]]) -> Dict[str, List[str]]:
        """
